    ...
    $(function(){
        ...
        IMP.request_pay({
            ...
            if ( rsp.success ) {
                ...
                //성공시 이동할 페이지
                 location.href='<%=request.getContextPath()%>/CodeChatServlet?command=paySuccess&code=<%=code%>&msg='+msg; 
            } else {
                msg = '결제에 실패하였습니다.';
                msg += '에러내용 : ' + rsp.error_msg;
                //실패시 이동할 페이지
                location.href="<%=request.getContextPath()%>/CodeChatServlet?command=payFail";
                alert(msg);
            }
        });
